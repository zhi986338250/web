	  		...
	  		<form action="<?php echo \core\basic\Url::get('/admin/Site/mod');?>" method="post" class="layui-form">
               ...
               <!-- <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                     ...
                     <div class="layui-input-block">
                     	<input type="text" name="domain" value="<?php echo @$this->getVar('sites')->domain;?>" placeholder="如：https://www.pb2345.com"  class="layui-input">
                     </div>
                </div>
...
<?php return array (
  ...
  1 => '/www/wwwroot/maitest.com/apps/admin/view/default/common/foot.html',
); ?>