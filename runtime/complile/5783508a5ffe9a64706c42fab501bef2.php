...
<!--左边end--> 
  <!--右边-->
  <div class="wfr wk2" data-scroll-reveal="enter right over 1s and move 300px">
    <div class="lmt oveh">
      <p class="lmt_1">{content:sortname}</p>
      <p class="lmt_2"><i class="icon iconfont">&#xe607;</i> 您的位置：{pboot:position separator=' > '}</p>
    </div>
    <div class="ab3">
      <div class="ab3_img"><img src="{content:ico}" alt="{content:title}" /></div>
    </div>
    <div class="ab1"> {content:title}</div>
    <div class="ab4" id="maximg"> {content:content} </div>
    <div class="fay">
      <div class="fal"> <a href="{content:prelink}">上一篇：{content:pretitle}</a> <a href="{content:nextlink}"> 下一篇：{content:nexttitle} </a> </div>
      <div class="far"><a href="javascript:window.opener=null;window.open('','_self');window.close();" class="bu bu2 borb">关闭</a></div>
    </div>
  </div>
  <!--右边end--> 
</div>
